...
export const defaultResumeData: ResumeData = {
  personal: {
    ...
    subtitle: "Building high-performance, beautiful web apps at the intersection of design & engineering",
  ...
  projects: [
    {
      ...
      description: "A beautiful, offline-first collaborative workspace for hyper-productive engineering teams.",
    ...
    },
    {
      id: "proj-2",
      title: "Nova UI Kit",
      description: "An ultra-accessible, modular React design system crafted with accessibility (WAI-ARIA) at its core.",
    ...
    },
    {
      ...
      description: "Real-time traffic analytics with interactive Canvas-based maps and user flow diagrams.",
    ...
    },
    {
      ...
      description: "A unified REST & GraphQL payment routing API supporting multi-currency ledger processing.",
